    ...
    <>
      ...
      <div className="container privacy-container">
        ...
        <div className="privacy-content">
          <p>
            At Valiram, we value your privacy and strive to protect your
            personal data in compliance with the governing laws of the countries
            we operate in.
          </p>
          <p>
          ...
          <p>
            ...
            changes to our privacy practices or for other legal, operational or
            regulatory reasons. If we amend this Privacy Policy, we will revise
            the “last updated” date located at the top of this Privacy Policy.
          </p>
          <p>
            By agreeing to this privacy policy, we (and our service providers,
            on our behalf) may use the information we collect from and about you
          ...
          <ul>
            ...
            <li>
              ...
              service) about our new stores, products, services, upcoming
              events, or promotions
            </li>
            <li>To facilitate your participation in any contests or events</li>
            <li>Where appropriate for market research</li>
            <li>
              Affiliate marketing initiatives with partners or third-party
              service provides related to Valiram
            </li>
          </ul>
        </div>
        <CommonButton
